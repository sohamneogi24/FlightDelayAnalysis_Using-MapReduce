...
public class Driver {
	...
	public static void main(String args[]) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Job job = Job.getInstance(conf, "Cancellation and Diversion Rate");
        job.setJarByClass(Driver.class);
        job.setMapperClass(CancellationDiversionMapper.class);

        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(CustomWritable.class);

        job.setReducerClass(CancellationDiversionReducer.class);
